...
This project provisions an AWS SecurityGroup using Terraform in a modular structure with CI/CD automation powered by GitHub Actions. It supports multi-environment deployments (dev, prod) and includes Infracost for cost estimation.
...
# References
AWS SecurityGroup - Terraform Docs
